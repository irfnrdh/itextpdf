...
var java = require("java"),
	fc = "";
java.classpath.push("itextpdf-5.5.13.jar");
try {
...
java.newInstance("com.itextpdf.text.Document", function (err, doc) {
	if (err) {
		console.log("Cannot create document object");
		return;
	}
	...
	(rectangle = java.newInstanceSync(
		...
		(fontHeading = java.newInstanceSync(
			"com.itextpdf.text.Font",
			font.FontFamily.TIMES_ROMAN,
			16,
			font.BOLD
		)),
		(fontBody = java.newInstanceSync(
			"com.itextpdf.text.Font",
	...
	(file = java.newInstanceSync("java.io.FileOutputStream", "v2Hello.pdf")),
		(heading = java.newInstanceSync(
			"com.itextpdf.text.Paragraph",
			"My World - An Essay",
			fontHeading
		)),
		(phrase = java.newInstanceSync(
			"com.itextpdf.text.Paragraph",
			fc,
			fontBody
		));
	...
	java.callMethodSync(
		anchor,
		"setReference",
		"http://www.teenink.com/nonfiction/travel_culture/article/491823/My-World/"
	);
